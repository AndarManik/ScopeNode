export const animateShot = (game, ctx, shot) => {
  ...
  ctx.beginPath();
  ctx.arc(...killedPosition, playerRadius - playerRadius / 2.5, 0, Math.PI * 2);
  ctx.stroke();
  ...
  if (dist > 0) {
    ...
    const exitAngleDeg = renderSettings.shellEjectAngleDeg ?? 120;
